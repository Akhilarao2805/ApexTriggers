trigger assigment6 on Case_Knowledge_Link__c (before insert,after insert,after delete) {
    //---6..Maintain Linked_Case_Count__c on Knowledge__kav whenever a Case_Knowledge_Link__c custom junction is inserted or deleted
